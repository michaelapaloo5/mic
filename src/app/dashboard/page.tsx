...
const GIRO_TRANSACTIONS: Transaction[] = [
  ...
  { id: 3, date: "02.07.2026", description: "Vorgemerkt: Großbetrag 235.000,00 €", amount: 235000, type: "credit", category: "Vorgemerkt" },
  { id: 4, date: "02.07.2026", description: "Miete Überweisung", amount: 1200.0, type: "debit", category: "Wohnen" },
  { id: 5, date: "01.07.2026", description: "REWE Märkte AG", amount: 87.43, type: "debit", category: "Lebensmittel" },
  { id: 6, date: "30.06.2026", description: "Netflix Abo", amount: 17.99, type: "debit", category: "Unterhaltung" },
  { id: 7, date: "28.06.2026", description: "Visa Debit", amount: 45.0, type: "debit", category: "Shopping" },
  { id: 8, date: "25.06.2026", description: "Überweisung von Anna Schmidt", amount: 150.0, type: "credit", category: "Rückzahlung" },
  { id: 9, date: "22.06.2026", description: "Visa Debit", amount: 3700.0, type: "debit", category: "Shopping" },
  { id: 10, date: "22.06.2026", description: "Visa Debit", amount: 79.98, type: "debit", category: "Shopping" },
  { id: 11, date: "22.06.2026", description: "DM-Drogerie Markt", amount: 32.15, type: "debit", category: "Drogerie" },
  { id: 12, date: "20.06.2026", description: "Stadtwerke Strom", amount: 89.50, type: "debit", category: "Energie" },
  { id: 13, date: "04.06.2026", description: "Amazon.de", amount: 240.0, type: "debit", category: "Shopping" },
  { id: 14, date: "30.05.2026", description: "Netflix Abo", amount: 17.99, type: "debit", category: "Unterhaltung" },
  ...
  { id: 17, date: "30.04.2026", description: "Netflix Abo", amount: 17.99, type: "debit", category: "Unterhaltung" },
  { id: 18, date: "15.04.2026", description: "Vorgemerkt: Großbetrag 235.000,00 €", amount: 235000, type: "credit", category: "Vorgemerkt" },
  { id: 19, date: "30.03.2026", description: "Netflix Abo", amount: 17.99, type: "debit", category: "Unterhaltung" },
  { id: 20, date: "25.03.2026", description: "Visa Debit", amount: 347.76, type: "debit", category: "Shopping" },
  { id: 21, date: "28.02.2026", description: "Netflix Abo", amount: 17.99, type: "debit", category: "Unterhaltung" },
  { id: 22, date: "15.02.2026", description: "Visa Debit", amount: 869.55, type: "debit", category: "Shopping" },
  { id: 23, date: "28.01.2026", description: "Netflix Abo", amount: 17.99, type: "debit", category: "Unterhaltung" },
  { id: 24, date: "28.01.2026", description: "Visa Debit", amount: 230.63, type: "debit", category: "Shopping" },
]
    ...
    <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-xl p-6">
          ...
          <p className="text-lg font-mono tracking-wider">**** **** **** 4967</p>
        ...
        <div className="bg-gradient-to-br from-gray-700 to-gray-900 text-white rounded-xl p-6">
          ...
          <p className="text-lg font-mono tracking-wider">**** **** **** 1462</p>
          <div className="flex justify-between items-end mt-6">
            <div>
              <p className="text-xs opacity-60">Gültig bis</p>
